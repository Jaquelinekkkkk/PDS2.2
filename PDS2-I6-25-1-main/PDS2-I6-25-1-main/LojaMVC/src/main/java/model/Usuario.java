...
public class Usuario implements Serializable {
    ...
    public Usuario(int id, String nome, String fone, String login, String senha, String perfil, LocalDate aniversario, String email) {
        this.id = id;
        this.nome = nome;
        this.fone = fone;
        this.login = login;
    ...
    public Usuario(String nome, String fone, String login, String senha, String perfil, LocalDate aniversario, String email) {
        this.nome = nome;
        this.fone = fone;
        this.login = login;
        this.senha = senha;
